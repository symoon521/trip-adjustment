...
3. Remove the generated sample files you do not need.
4. Add the contents of the local `TripAdjustment/` folder into the app target.
5. Keep the product notes in Obsidian as the decision log.
